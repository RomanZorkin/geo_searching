...
На данный момент сформирован датасет по 2 городам Барнаул и Белгород https://disk.yandex.ru/d/L3kSGb6-AeYriw. Датасет преддставляет собой два варианта данных по каждому городу. Изображения в виде панорам - каталог data_small/belgorod&barnaul и изображения в виде 4-х сторон каждой панорамы data_small/belgorod_crop&barnaul_crop. разрезанных изображений чуть более 900 тыс. Для каждого изображения в файле datset_info.csv имеются координаты, азимут, название города
...
Про нейросеть CLIP https://habr.com/ru/articles/539312/
